...
# ╔═╡ 2fc66214-8c71-11ee-1a7f-0d3bd28cf315
using WaterLily

# ╔═╡ 177c72a7-435f-484d-9e16-358fd250679c
using Plots

# ╔═╡ b6052305-80db-4f32-ad2c-bba4836cd448
...
# ╔═╡ a042831e-467c-4759-8ce6-84b69f00707c
begin
...
# ╔═╡ a0896b6b-eb03-41a7-9093-d2579f5737a2
contour(circ.flow.p')
...
julia_version = "1.9.4"
manifest_format = "2.0"
project_hash = "f0f3da24e8cc258f706f8c9e83c5f06c4d92e46a"
...
[[deps.WaterLily]]
deps = ["AMDGPU", "CUDA", "Documenter", "ForwardDiff", "KernelAbstractions", "LinearAlgebra", "Reexport", "StaticArrays", "TOML", "Test"]
git-tree-sha1 = "eaf4074f34208361186236c8d147e1d9fa35e3d1"
