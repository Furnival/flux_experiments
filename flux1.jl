...
# ╔═╡ ea62cf38-8c6c-11ee-1601-0f98248327a4
using Flux

# ╔═╡ 3ae11025-6fe0-4952-9dd1-3f4ff7b4c4ef
using Statistics

# ╔═╡ e4798496-6e64-4d7c-acbf-1c3beb5d551f
using Flux: train!

# ╔═╡ 407cfe65-7ebb-456b-86a5-4233a855a66a
actual(x) = 4x + 2

# ╔═╡ 19cb8d7f-95ec-42bc-9139-94de7cb40f2d
x_train, x_test = hcat(0:5...), hcat(6:10...)

# ╔═╡ bc4f8c72-ca25-4ec3-bf6a-b4a254e2fffd
y_train, y_test = actual.(x_train), actual.(x_test)

# ╔═╡ 2ac29691-ee45-44fa-9307-c1f8d8030cb8
model = Dense(1 => 1)

# ╔═╡ ef7b793b-4fe8-4a93-9044-ab8f0a0bfb18
model.weight

# ╔═╡ c1b538e5-0552-473d-930f-d76883fca61c
model.bias

# ╔═╡ b72e8bf2-fd45-46b0-adac-7c84d57df845
predict = Dense(1 => 1)

# ╔═╡ c750bd5d-a17e-438f-bf1b-cea47faeb570
predict(x_train)

# ╔═╡ 8553c5f8-b8ce-4c38-8434-6dde04b9935f
loss(model, x, y) = mean(abs2.(model(x) .- y));

# ╔═╡ ed6264ae-5221-4272-962f-f7ac4349f211
loss(predict, x_train, y_train)

# ╔═╡ 3f4fac69-54aa-4ca1-88e9-b6f24bccbea0
opt = Descent()

# ╔═╡ 2a065c09-8ca7-4b1d-843b-1b9ac24c77ac
data = [(x_train, y_train)]

# ╔═╡ f390feaa-898e-4b2c-bb2d-b816450314ea
predict.weight

# ╔═╡ e00d75f4-3b1d-4472-80af-ac4609861a8e
predict.bias

# ╔═╡ 0d4378a7-7e0f-4780-956f-48e6e94e9bec
train!(loss, predict, data, opt)

# ╔═╡ 8b75d769-3b43-457e-acc9-d436a1bbe97b
loss(predict, x_train, y_train)

# ╔═╡ a79cf968-d3d9-4e8d-9aa1-18cf0b2f754d
predict.weight, predict.bias

# ╔═╡ 4b715de2-630a-4c22-a36b-4f879deb2330
for epoch in 1:200
         train!(loss, predict, data, opt)
end

# ╔═╡ b8169224-119d-40dc-a68b-7ed67e342ef0
loss(predict, x_train, y_train)

# ╔═╡ 0f02d10b-e91c-4200-afa8-e4b2f4a7cf4b
predict.weight, predict.bias

# ╔═╡ ec680b30-988b-4f9f-8584-1b52bf41cf1a
predict(x_test)

# ╔═╡ ae1d54e1-b9c4-47b7-8460-f54ac080294a
y_test

# ╔═╡ 20bc254a-d610-43d6-806d-ec2216b283ad
md"""
...
julia_version = "1.9.4"
manifest_format = "2.0"
project_hash = "1374947294c2fe799bf8bd38706ecaa66582d851"
